...
__version__ = importlib_metadata.metadata("simple-atm-controller")["Version"]
app = typer.Typer()
...
def version_callback(value: Optional[bool]):  # pylint: disable=unsubscriptable-object
    ...
    if value:
        typer.echo(f"simple-atm-controller Version: {__version__}")
        raise typer.Exit()
...
if __name__ == "__main__":
    app(prog_name="simple-atm-controller")  # pragma: no cover
