...
==============================
![CI](https://github.com/TeoZosa/simple-atm-controller/workflows/CI/badge.svg)
![codecov](https://codecov.io/gh/TeoZosa/simple-atm-controller/branch/master/graph/badge.svg?token=3HF21UWY82)
![License](https://img.shields.io/github/license/TeoZosa/simple-atm-controller?style=plastic)
![PyPI - Python Version](https://img.shields.io/pypi/pyversions/simple-atm-controller?style=plastic)
![PyPI](https://img.shields.io/pypi/v/simple-atm-controller?color=informational&style=plastic)
...
[![Dependabot](https://api.dependabot.com/badges/status?host=github&repo=TeoZosa/simple-atm-controller)](https://dependabot.com/)


---

**Documentation**: [https://simple-atm-controller.readthedocs.io](https://simple-atm-controller.readthedocs.io)

**Source Code**: [https://github.com/TeoZosa/simple-atm-controller](https://github.com/TeoZosa/simple-atm-controller)
...
Installation
============
You can install Simple ATM Controller via [pip](https://pip.pypa.io/):
 ```shell script
pip install simple-atm-controller
```
...
Simple ATM Controller is licensed under the Apache License, Version 2.0.
